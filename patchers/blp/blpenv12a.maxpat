...
,
		"classnamespace" : "box",
		"rect" : [ 1222.0, -1298.0, 1452.0, 928.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 957.0, 25.0, 231.0, 20.0 ],
					"text" : "arg2 : envelope name"
				}

			}
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0 ],
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 194.0, 511.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 872.0, 50.0, 204.0, 21.0 ],
					"text" : "t b 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1285.0, 479.0, 39.0, 21.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 971.0, 131.0, 99.0, 21.0 ],
					"text" : "s #0_grid"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 974.0, 102.0, 18.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 452.0, 1.0, 16.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1139.0, 102.0, 16.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 486.0, 1.0, 16.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1130.0, 229.0, 36.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 542.0, 0.0, 33.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					"bordercolor" : [ 0.668252052034861, 0.37753979111903, 0.316055506131883, 1.0 ],
					"id" : "obj-75",
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1338.0, 539.0, 11.0, 10.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 563.0, 118.0, 12.0, 12.0 ],
					"saved_attribute_attributes" : 					{
						"bordercolor" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1282.0, 240.0, 100.0, 22.0 ],
					"text" : "prepend symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 737.0, 104.0, 22.0 ],
					"text" : "vol 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.0, 2.0, 32.0, 10.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 376.0, 2.0, 235.0, 10.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 2.0, 65.0, 10.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.0, 2.0, 65.0, 10.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 2.0, 17.0, 11.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1299.0, 269.0, 118.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1282.0, 420.0, 50.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1282.0, 680.0, 66.0, 22.0 ],
					"text" : "$3 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1285.0, 505.0, 64.0, 21.0 ],
					"text" : "del 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1285.0, 453.0, 64.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1285.0, 536.0, 40.0, 21.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1282.0, 713.0, 141.0, 21.0 ],
					"text" : "s #0_defranges"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1282.0, 643.0, 79.0, 21.0 ],
					"text" : "pack 0. 0. s"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1285.0, 601.0, 85.0, 21.0 ],
					"text" : "unpack s 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1285.0, 564.0, 127.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1336.0, 351.0, 34.0, 21.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1299.0, 351.0, 33.0, 21.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1282.0, 387.0, 127.0, 21.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 957.0, 3.0, 231.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 673.0, 100.0, 22.0 ],
					"text" : "r #0_to-out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1136.0, 159.0, 104.0, 21.0 ],
					"text" : "s #1_toenv"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1136.0, 131.0, 58.0, 20.0 ],
					"text" : "legend $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 399.0, 105.0, 21.0 ],
					"text" : "s #0_env-on"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 16.0, 355.0, 16.0, 31.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 1324.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 1226.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 1124.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 1022.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 920.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 818.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 716.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 614.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 512.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 410.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 308.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 205.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 105.0, 115.0, 34.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 129.5, 148.35546875, 114.5, 148.35546875 ],
									"source" : [ "obj-11", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 434.5, 158.015625, 419.5, 158.015625 ],
									"source" : [ "obj-17", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 229.5, 166.765625, 214.5, 166.765625 ],
									"source" : [ "obj-29", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 536.5, 156.79296875, 521.5, 156.79296875 ],
									"source" : [ "obj-32", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 332.5, 160.66796875, 317.5, 160.66796875 ],
									"source" : [ "obj-37", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 638.5, 156.66796875, 623.5, 156.66796875 ],
									"source" : [ "obj-46", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 740.5, 160.64453125, 725.5, 160.64453125 ],
									"source" : [ "obj-53", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 842.5, 156.1875, 827.5, 156.1875 ],
									"source" : [ "obj-60", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 944.5, 171.8046875, 929.5, 171.8046875 ],
									"source" : [ "obj-67", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1046.5, 171.8046875, 1031.5, 171.8046875 ],
									"source" : [ "obj-74", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1148.5, 171.8046875, 1133.5, 171.8046875 ],
									"source" : [ "obj-81", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1250.5, 171.8046875, 1235.5, 171.8046875 ],
									"source" : [ "obj-88", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1348.5, 171.8046875, 1333.5, 171.8046875 ],
									"source" : [ "obj-96", 1 ]
								}
...
,
					"patching_rect" : [ 119.0, 112.0, 391.000000000000227, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1232.0, 455.0, 29.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1232.0, 431.0, 29.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 553.0, 32.0, 28.0, 18.0 ],
					"text" : "%",
					"textcolor" : [ 0.666666666666667, 0.658823529411765, 0.658823529411765, 1.0 ],
					"varname" : "sec[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1217.0, 50.0, 109.0, 21.0 ],
					"text" : "s #1_toenv"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1217.0, 14.0, 142.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1217.0, 756.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1216.0, 775.0, 31.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1220.0, 798.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1220.0, 821.0, 32.0, 22.0 ],
					"text" : "f -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1072.0, 807.0, 45.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1140.0, 761.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 157.0, 204.0, 80.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.0, 154.0, 132.0, 22.0 ],
									"text" : "r #2_smoothenv"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 228.0, 310.0, 46.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 278.0, 310.0, 78.0, 22.0 ],
									"text" : "vmod amt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 228.0, 270.0, 110.0, 22.0 ],
...
,
					"patching_rect" : [ 952.0, 862.0, 110.0, 22.0 ],
					"text" : "p vmod amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 924.0, 775.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1163.0, 775.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1162.0, 821.0, 53.0, 22.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 718.0, 69.0, 100.0, 21.0 ],
									"text" : "r #0_grid"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 718.0, 133.5, 62.0, 22.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 686.0, 191.5, 32.0, 22.0 ],
									"text" : "$3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 686.0, 246.0, 89.0, 22.0 ],
									"text" : "gridstep_y $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 718.0, 168.5, 83.0, 22.0 ],
									"text" : "snap2grid $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 718.0, 100.5, 62.0, 22.0 ],
									"text" : "route int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 560.0, 129.5, 84.0, 22.0 ],
									"text" : "vmod set 10"
								}
...
,
					"patching_rect" : [ 1083.0, 862.0, 96.0, 22.0 ],
					"text" : "p vmod set 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 848.0, 765.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 847.0, 784.0, 34.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 851.0, 807.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 851.0, 830.0, 30.0, 22.0 ],
					"text" : "f -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 703.0, 816.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 771.0, 770.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.0, 316.0, 46.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 292.0, 316.0, 78.0, 22.0 ],
									"text" : "HF amt"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 242.0, 276.0, 110.0, 22.0 ],
									"text" : "patcherargs vol"
								}
...
,
					"patching_rect" : [ 583.0, 871.0, 110.0, 22.0 ],
					"text" : "p HF amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 555.0, 784.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 794.0, 784.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 793.0, 830.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 703.0, 54.0, 100.0, 21.0 ],
									"text" : "r #0_grid"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 703.0, 118.5, 62.0, 22.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 671.0, 176.5, 32.0, 22.0 ],
									"text" : "$3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 671.0, 231.0, 89.0, 22.0 ],
									"text" : "gridstep_y $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 703.0, 153.5, 83.0, 22.0 ],
									"text" : "snap2grid $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 703.0, 85.5, 62.0, 22.0 ],
									"text" : "route int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 529.5, 131.0, 71.5, 22.0 ],
									"text" : "HF set 0.1"
								}
...
,
					"patching_rect" : [ 719.0, 871.0, 93.0, 22.0 ],
					"text" : "p HF set 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 479.0, 774.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 478.0, 793.0, 40.0, 22.0 ],
					"text" : "f 15"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 482.0, 816.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 482.0, 839.0, 35.0, 22.0 ],
					"text" : "f -15"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 334.0, 825.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 402.0, 779.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 214.0, 880.0, 110.0, 22.0 ],
					"text" : "p HG amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 186.0, 793.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 425.0, 793.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 424.0, 839.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 530.5, 131.0, 71.5, 22.0 ],
									"text" : "HG set 1"
								}
...
,
					"patching_rect" : [ 343.0, 880.0, 71.0, 22.0 ],
					"text" : "p HG set 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1195.0, 619.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1194.0, 638.0, 30.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1198.0, 661.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1198.0, 684.0, 27.0, 22.0 ],
					"text" : "f -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1050.0, 670.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1118.0, 624.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 157.0, 174.0, 80.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.0, 124.0, 132.0, 22.0 ],
									"text" : "r #2_smoothenv"
								}
...
,
					"patching_rect" : [ 930.0, 725.0, 110.0, 22.0 ],
					"text" : "p LF amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 902.0, 638.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1141.0, 638.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1140.0, 684.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 558.0, 131.5, 91.0, 22.0 ],
									"text" : "LF set 0.1"
								}
...
,
					"patching_rect" : [ 1060.0, 725.0, 73.5, 22.0 ],
					"text" : "p LF set 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 840.0, 622.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 839.0, 641.0, 30.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 843.0, 664.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 843.0, 687.0, 27.0, 22.0 ],
					"text" : "f -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 695.0, 673.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 763.0, 627.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 243.0, 310.0, 46.0, 22.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.0, 310.0, 78.0, 22.0 ],
									"text" : "LG amt"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 243.0, 237.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 243.0, 270.0, 110.0, 22.0 ],
									"text" : "patcherargs vol"
								}
...
,
					"patching_rect" : [ 575.0, 728.0, 110.0, 22.0 ],
					"text" : "p LG amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 547.0, 641.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 786.0, 641.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 785.0, 687.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 528.0, 129.0, 70.0, 22.0 ],
									"text" : "LG set 1"
								}
...
,
					"patching_rect" : [ 703.0, 728.0, 84.0, 22.0 ],
					"text" : "p LG set 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 484.0, 636.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 483.0, 655.0, 30.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 487.0, 678.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 487.0, 701.0, 35.0, 22.0 ],
					"text" : "f -15"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 339.0, 687.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 407.0, 641.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 219.0, 742.0, 110.0, 22.0 ],
					"text" : "p BQ amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 191.0, 655.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 430.0, 655.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 429.0, 701.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 527.0, 130.0, 76.0, 22.0 ],
									"text" : "BQ set 0.1"
								}
...
,
					"patching_rect" : [ 338.0, 742.0, 85.0, 22.0 ],
					"text" : "p BQ set 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1170.0, 485.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1172.0, 504.0, 30.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1173.0, 527.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1173.0, 550.0, 27.0, 22.0 ],
					"text" : "f -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1025.0, 536.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1093.0, 490.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 905.0, 591.0, 110.0, 22.0 ],
					"text" : "p BF amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 877.0, 504.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1116.0, 504.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1115.0, 550.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 521.0, 130.0, 75.0, 22.0 ],
									"text" : "BF set 0.1"
								}
...
,
					"patching_rect" : [ 1041.0, 591.0, 121.0, 22.0 ],
					"text" : "p BF set 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 814.0, 489.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 814.0, 508.0, 30.0, 22.0 ],
					"text" : "f 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 817.0, 531.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 817.0, 554.0, 27.0, 22.0 ],
					"text" : "f -1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 669.0, 540.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 737.0, 494.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 549.0, 595.0, 110.0, 22.0 ],
					"text" : "p BG amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 521.0, 508.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.0, 508.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 759.0, 554.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 535.0, 128.0, 74.0, 22.0 ],
									"text" : "BG set 1"
								}
...
,
					"patching_rect" : [ 685.0, 595.0, 121.0, 22.0 ],
					"text" : "p BG set 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 459.0, 492.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 458.0, 511.0, 40.0, 22.0 ],
					"text" : "f 15"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 462.0, 534.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 462.0, 557.0, 35.0, 22.0 ],
					"text" : "f -15"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 314.0, 543.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 382.0, 497.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 194.0, 598.0, 110.0, 22.0 ],
					"text" : "p pitmod amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 166.0, 511.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 405.0, 511.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 404.0, 557.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 526.0, 133.0, 92.0, 22.0 ],
									"text" : "pitmod set 10"
								}
...
,
					"patching_rect" : [ 319.0, 598.0, 121.0, 22.0 ],
					"text" : "p pitmod set 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1170.0, 346.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1169.0, 365.0, 35.0, 22.0 ],
					"text" : "f 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1173.0, 388.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1173.0, 411.0, 40.0, 22.0 ],
					"text" : "f -100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1025.0, 397.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1093.0, 351.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 905.0, 452.0, 110.0, 22.0 ],
					"text" : "p pit amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 877.0, 365.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1116.0, 365.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1115.0, 411.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
,
					"patching_rect" : [ 1041.0, 452.0, 121.0, 22.0 ],
					"text" : "p pit set 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.0, 135.0, 166.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 2.0, 23.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 214.0, 29.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 513.0, 81.0, 29.0, 18.0 ],
					"text" : "min",
					"textcolor" : [ 0.666666666666667, 0.658823529411765, 0.658823529411765, 1.0 ],
					"varname" : "min"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 169.0, 28.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 513.0, 9.0, 28.0, 18.0 ],
					"text" : "max",
					"textcolor" : [ 0.666666666666667, 0.658823529411765, 0.658823529411765, 1.0 ],
					"varname" : "max"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 147.0, 55.0, 17.0 ],
					"text" : "> amt",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 872.0, 3.0, 63.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 554.0, 50.0, 100.0, 22.0 ],
					"restore" : 					{
						"env-name" : [ 4 ],
						"lin-curv" : [ 1.0 ],
						"live.button" : [ 0.0 ],
						...
						"minval[8]" : [ -15.0 ],
						"minval[9]" : [ -2.0 ],
						"volenv" : [ 100.0, -30.0, 6.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[10]" : [ 100.0, -15.0, 15.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[11]" : [ 100.0, -2.0, 2.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[12]" : [ 100.0, -30.0, 6.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[1]" : [ 100.0, 0.0, 5.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[2]" : [ 100.0, 0.0, 5.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[3]" : [ 100.0, -100.0, 100.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[4]" : [ 100.0, -100.0, 100.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[5]" : [ 100.0, -15.0, 15.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[6]" : [ 100.0, -2.0, 2.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[7]" : [ 100.0, -2.0, 2.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[8]" : [ 100.0, -15.0, 15.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ],
						"volenv[9]" : [ 100.0, -2.0, 2.0, 0.0, 0.0, 0, 0.0, 50.0, 0.0, 0, 0.0, 100.0, 0.0, 0, 0.0, "curve" ]
					}
,
					"text" : "autopattr",
					"varname" : "u598009913"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 914.0, 132.0, 28.0, 21.0 ],
					"text" : "0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 916.0, 102.0, 14.0, 14.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 872.0, 124.0, 28.0, 21.0 ],
					"text" : "0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 873.0, 103.0, 14.0, 14.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 501.0, 16.0, 14.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgoncolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 835.0, 110.0, 10.0, 77.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 502.0, 30.0, 12.0, 89.0 ],
					"size" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 829.0, 191.0, 82.0, 21.0 ],
					"text" : "zoom_y $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 914.0, 171.0, 90.0, 10.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 914.0, 191.0, 85.0, 21.0 ],
					"text" : "zoom_x $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 810.0, 346.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 809.0, 365.0, 35.0, 22.0 ],
					"text" : "f 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 813.0, 388.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 813.0, 411.0, 45.0, 22.0 ],
					"text" : "f -100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 665.0, 397.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 733.0, 351.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
					"patching_rect" : [ 545.0, 452.0, 85.0, 22.0 ],
					"text" : "p posmod amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 517.0, 365.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 756.0, 365.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 755.0, 411.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"triscale" : 0.7,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 546.0, 128.0, 96.0, 22.0 ],
									"text" : "posmod set 10"
								}
...
,
					"patching_rect" : [ 670.0, 448.0, 138.0, 22.0 ],
					"text" : "p posmod set 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 71.0, 77.333335638046265, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 450.0, 293.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 449.0, 313.0, 40.0, 22.0 ],
					"text" : "f 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 453.0, 148.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 17.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 453.0, 167.0, 40.0, 22.0 ],
					"text" : "f 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 457.0, 342.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 453.0, 365.0, 24.0, 22.0 ],
					"text" : "f 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 3.0, 113.0, 22.0 ],
					"text" : "r #1_toenv"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 343.0, 338.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 372.0, 307.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 350.0, 153.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 0.0, 18.0, 14.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 155.0, 204.0, 80.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 155.0, 154.0, 132.0, 22.0 ],
									"text" : "r #2_smoothenv"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.0, 317.0, 90.0, 22.0 ],
									"text" : "pos amt"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 233.0, 244.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 233.0, 277.0, 110.0, 22.0 ],
									"text" : "patcherargs vol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 259.0, 124.0, 22.0 ],
									"text" : "pack 0. 20"
								}
...
,
					"patching_rect" : [ 150.0, 398.0, 110.0, 22.0 ],
					"text" : "p pos amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 113.0, 320.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.0, 359.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"varname" : "minval[1]"
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 693.0, 32.5, 100.0, 21.0 ],
									"text" : "r #0_grid"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 611.0, 139.0, 25.0, 22.0 ],
									"text" : "$3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 634.0, 59.0, 35.0, 22.0 ],
									"text" : "/ 10."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 634.0, 32.0, 35.0, 22.0 ],
									"text" : "!- 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 693.0, 118.0, 40.0, 22.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 634.0, 253.5, 89.0, 22.0 ],
									"text" : "gridstep_y $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 693.0, 153.0, 83.0, 22.0 ],
									"text" : "snap2grid $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 693.0, 80.0, 62.0, 22.0 ],
									"text" : "route int"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 545.0, 307.0, 27.0, 27.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 467.0, 307.0, 27.0, 27.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 406.0, 307.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 338.0, 307.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 283.0, 398.0, 101.0, 22.0 ],
					"text" : "p pos set 1"
				}
...
,
					"patching_rect" : [ 16.0, 111.0, 49.0, 21.0 ],
					"text" : "p script"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 734.0, 27.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 16.0, 153.0, 64.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 286.0, 199.0, 23.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 853.5, 240.0, 124.0, 22.0 ],
					"text" : "s #1_toenv"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 187.0, 189.0, 80.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 246.0, 275.0, 110.0, 22.0 ],
									"text" : "patcherargs vol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.0, 139.0, 132.0, 22.0 ],
									"text" : "r #2_smoothenv"
								}
...
,
					"patching_rect" : [ 119.0, 254.0, 79.0, 22.0 ],
					"text" : "p vol amt"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 455.0, 206.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 559.0, 90.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 455.0, 229.0, 36.0, 22.0 ],
					"text" : "f 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 88.0, 170.0, 27.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 301.0, 197.0, 45.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 523.0, 113.0, 53.0, 22.0 ],
					"textcolor" : [ 0.466666666666667, 0.592156862745098, 0.647058823529412, 1.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1079.0, 132.0, 51.0, 20.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 375.0, 167.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 23.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"varname" : "maxval"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 373.0, 212.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 95.0, 53.0, 22.0 ],
					"textcolor" : [ 0.611764705882353, 0.776470588235294, 0.850980392156863, 1.0 ],
					"varname" : "minval"
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 663.0, 53.0, 100.0, 21.0 ],
									"text" : "r #0_grid"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 663.0, 118.0, 62.0, 22.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 631.0, 204.5, 32.0, 22.0 ],
									"text" : "$3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 631.0, 307.0, 89.0, 22.0 ],
									"text" : "gridstep_y $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 663.0, 153.0, 83.0, 22.0 ],
									"text" : "snap2grid $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 663.0, 85.0, 62.0, 22.0 ],
									"text" : "route int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 537.0, 204.5, 75.0, 22.0 ],
									"text" : "vol set 1"
								}
...
,
					"patching_rect" : [ 238.0, 254.0, 108.0, 22.0 ],
					"text" : "p vol set 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 174.0, 3.0, 482.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1083.0, 102.0, 16.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 469.0, 1.0, 16.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.0, 3.0, 68.0, 83.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 85.0, 129.0, 21.0 ],
					"text" : "s #0_setdomain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 162.0, 60.0, 91.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 170.0, 245.0, 64.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -30.0, 6.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 150.0, 320.0, 245.0, 57.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ 0.0, 5.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 545.0, 365.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ 0.0, 5.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 905.0, 365.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -100.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 549.0, 508.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -15.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 905.0, 504.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -2.0, 2.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.0, 655.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -2.0, 2.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 575.0, 641.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -15.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 930.0, 638.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -2.0, 2.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.0, 793.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -15.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 583.0, 784.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -2.0, 2.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 952.0, 775.0, 209.0, 68.0 ],
					"pointsize" : 4.0,
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 17.0, 500.0, 100.0 ],
					"range" : [ -30.0, 6.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 175.5, 588.401044130325317, 294.5, 588.401044130325317 ],
					"source" : [ "obj-121", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 530.5, 584.901044130325317, 649.5, 584.901044130325317 ],
					"source" : [ "obj-141", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 886.5, 581.401044130325317, 1005.5, 581.401044130325317 ],
					"source" : [ "obj-155", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 200.5, 732.401044130325317, 319.5, 732.401044130325317 ],
					"source" : [ "obj-171", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 556.5, 718.401044130325317, 675.5, 718.401044130325317 ],
					"source" : [ "obj-185", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 122.5, 389.01953125, 250.5, 389.01953125 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 911.5, 714.901044130325317, 1030.5, 714.901044130325317 ],
					"source" : [ "obj-199", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 195.5, 870.401044130325317, 314.5, 870.401044130325317 ],
					"source" : [ "obj-213", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 564.5, 861.401044130325317, 683.5, 861.401044130325317 ],
					"source" : [ "obj-227", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 933.5, 852.401044130325317, 1052.5, 852.401044130325317 ],
					"source" : [ "obj-241", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 183.5, 50.578125, 25.5, 50.578125 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 886.5, 442.401044130325317, 1005.5, 442.401044130325317 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 526.5, 442.401044130325317, 620.5, 442.401044130325317 ],
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 198.3984375, 808.01171875 ],
					"order" : 68,
					"source" : [ "obj-87", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 97.5, 246.13671875, 188.5, 246.13671875 ],
					"source" : [ "obj-91", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-67" : [ "amt[2]", "gain", 0 ],
			"obj-72" : [ "lin-curv", "lin-curv", 0 ],
			"obj-75" : [ "live.button[91]", "live.button", 0 ],
			"obj-91" : [ "amt", "gain", 0 ],
			"obj-97" : [ "live.text[67]", "live.text", 0 ],
			"obj-98" : [ "legend", "legend", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
