...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 158.0, 44.0, 20.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 184.0, 66.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 158.0, 44.0, 20.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 184.0, 66.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 38.0, 45.0, 47.0, 17.0 ],
					"text" : "131",
					"textcolor" : [ 0.611764705882353, 0.690196078431373, 0.72156862745098, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 354.0, 112.0, 72.0, 22.0 ],
					"text" : "route view"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 274.0, 125.0, 72.0, 22.0 ],
					"text" : "route view"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 805.0, 149.5, 50.0, 14.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 835.0, 181.5, 34.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.5, 69.0, 65.5, 17.0 ],
					"text" : "0.-5.k",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 393.0, 163.0, 32.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 637.0, 72.0, 21.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 669.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "patcherargs freq inc 131. 0. @min 0. @max 5000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 633.0, 163.0, 21.0 ],
					"text" : "increment 0. 131.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 110.0, 12.0, 100.0, 35.0 ],
					"restore" : 					{
						"numdev1" : [ 0.0 ],
						"numdev2" : [ 131.0 ],
						"numease1" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 201.0, 386.0, 57.0, 21.0 ],
					"presentation" : 1,
