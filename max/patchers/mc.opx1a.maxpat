...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 661.0, 197.0, 48.0, 20.0 ],
					"text" : "0.01"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 96.0, 184.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 83.0, 151.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 601.0, 197.0, 48.0, 20.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 69.0, 151.0, 18.0 ],
					"text" : "arg2:  op name, def. inc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 770.0, 165.0, 78.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 68.0, -2.0, 61.0, 17.0 ],
					"text" : "0.>100.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 885.0, 119.0, 140.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 885.0, 102.0, 140.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 534.0, 197.0, 48.0, 20.0 ],
					"text" : "val"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 116.0, 134.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.0, 158.0, 31.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 111.0, -2.0, 66.0, 17.0 ],
					"text" : "dev",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 52.0, -2.0, 66.0, 17.0 ],
					"text" : "val",
					"textcolor" : [ 0.592156862745098, 0.592156862745098, 0.592156862745098, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 546.0, 69.0, 288.0, 22.0 ],
					"text" : "patcherargs val dev 0. 0.01 @min 0. @max 100."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 867.0, 26.0, 226.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 57.0, 200.0, 18.0 ],
					"text" : "arg1: name of value , def. val , like Hz etc"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 13.0, 45.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 94.0, 13.0, 46.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 13.0, 45.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 13.0, 49.0, 21.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 400.5, 69.0, 21.0 ],
					"text" : "prepend set"
				}
