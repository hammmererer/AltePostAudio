...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 340.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 533.0, -4.0, 30.0, 17.0 ],
					"text" : "gain",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 530.0, 10.0, 37.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 308.0, 164.0, 272.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 586.0, 247.0, 32.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 308.0, 179.0, 389.471253395080566, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 553.0, 238.0, 32.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 308.0, 149.0, 367.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 714.0, 100.0, 20.0, 20.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 902.5, 583.0, 59.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 738.0, 101.0, 19.0, 19.0 ],
					"varname" : "button[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 841.5, 583.0, 59.0, 34.0 ],
					"text" : "loadmess poll"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 762.0, 39.0, 29.885056972503662, 20.0 ],
					"text" : "87 !"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 714.0, 38.0, 40.243903398513794, 22.0 ],
					"varname" : "number[5]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 713.0, 37.0, 43.902440071105957, 24.390244483947754 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 708.0, 17.0, 60.0, 20.0 ],
					"text" : "zoom (%)"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 697.0, 1.0, 14.0, 149.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 145.0, 701.0, 8.0 ]
				}
...
,
					"patching_rect" : [ 19.0, 437.0, 85.0, 25.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 509.0, 4.0, 25.0, 19.0 ],
					"textcolor" : [ 0.623529411764706, 0.623529411764706, 0.623529411764706, 1.0 ],
					"triangle" : 0,
					"varname" : "number[3]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 486.0, 0.0, 27.0, 39.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 233.0, 83.0, 70.0, 21.0 ],
					"triscale" : 0.75,
					"varname" : "selstart"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 308.0, 83.0, 57.0, 21.0 ],
					"triscale" : 0.75,
					"varname" : "selend"
				}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 22.0, 21.0, 59.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 103.0, 23.0, 262.0, 58.0 ],
					"setmode" : 3
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 1.0, 263.0, 21.0 ],
					"types" : [ "WAVE", "AIFF" ],
					"varname" : "names"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 386.0, 91.0, 11.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 224.0, 126.0, 24.0, 17.0 ],
					"text" : "fout",
					"textcolor" : [ 0.850980392156863, 0.850980392156863, 0.850980392156863, 0.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 163.0, 126.0, 23.0, 17.0 ],
					"text" : "fin",
					"textcolor" : [ 0.850980392156863, 0.850980392156863, 0.850980392156863, 0.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.0, 126.0, 40.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 126.0, 40.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 2.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 373.0, 124.0, 78.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.0, 124.0, 64.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 636.0, 2.0, 10.0, 124.0 ],
					"saved_attribute_attributes" : 					{
						"linecolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 35.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 20.0, 15.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgoncolor" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 610.0, 126.0, 16.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 682.0, 126.0, 16.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 399.0, 91.0, 75.0, 50.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 8,
					"spacing" : 2,
					"varname" : "mslider8"
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						...
						"noise" : [ 75.000005960464478 ],
						"pshift" : [ 0.000000000000007 ],
						"selend" : [ 30010.635959015795379 ],
						"selstart" : [ 61936.827539866178995 ],
						"spread" : [ 0.0 ],
						"stretch" : [ 2.002024006843566 ],
						"tonalnoise" : [ 0.0 ],
						"xfade" : [ 1.000000070780516 ]
					}
,
					"text" : "autopattr",
					"varname" : "u900021619"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 398.0, 44.0, 77.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 436.0, 56.0, 37.0, 19.0 ],
					"text" : "noise"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 434.0, 70.0, 40.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 401.0, 56.0, 27.0, 19.0 ],
					"text" : "BW"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 395.0, 70.0, 40.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 86.0, 44.0, 19.0 ],
					"text" : "xfad"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 87.0, 45.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 5 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 384.0, 0.0, 45.0, 18.0 ],
					"text" : "high.cut"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 425.0, 1.0, 50.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 384.0, 16.0, 39.0, 18.0 ],
					"text" : "low.cut"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 425.0, 17.0, 50.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 3.0,
							"parameter_initial" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 289.0, 125.0, 38.0, 19.0 ],
					"text" : "comp"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 321.0, 126.0, 45.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 70.0, 44.0, 19.0 ],
					"text" : "fsprd"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 71.0, 45.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 54.0, 44.0, 19.0 ],
					"text" : "fshift"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 55.0, 45.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 38.0, 44.0, 19.0 ],
					"text" : "pshift"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 39.0, 45.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 2.0,
							"parameter_linknames" : 1,
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 124.0, 44.0, 21.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 84.0, 42.0, 19.0 ],
					"text" : "stretch"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 85.0, 45.0, 17.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 571.0, 124.0, 28.0, 22.0 ],
					"textcolor" : [ 0.623529411764706, 0.623529411764706, 0.623529411764706, 1.0 ],
					"triangle" : 0,
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"pattrstorage" : "pauls",
					"presentation" : 1,
					"presentation_rect" : [ 573.0, 1.0, 125.0, 125.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 762.0, 350.0, 125.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 476.0, 42.0, 63.0, 102.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 34.0, 378.0, 161.0, 25.0 ],
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "cfa9f2def11d3216bcce81f0fc8750e4"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 9/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "5752832bee05d76bd9afe44600765c26"
									}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 639.0, 124.0, 17.0, 19.0 ],
					"text" : "W",
					"varname" : "message[1]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 659.0, 124.0, 16.0, 19.0 ],
					"text" : "R",
					"varname" : "message"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 90.833333333333343, 411.52734375, 214.028645833333314, 411.52734375, 214.028645833333314, 394.0, 314.5, 394.0 ],
					"order" : 0,
					"source" : [ "obj-1", 2 ]
				}
